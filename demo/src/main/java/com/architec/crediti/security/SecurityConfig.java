...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                //COORDINATOR && DOCENT
                .antMatchers("/detailAssignmentEnrolled/{id}", "/allFullAssignments", "/listStudents", "/unapprovedEnrollments", "/approveEnroll/{id}", "/deleteEnroll/{id}").hasAnyRole("DOCENT", "COORDINATOR")
                ...
                //For all but EXTERN
                .antMatchers("/listAllAssignments", "/allassignments", "/documentation", "/duplicateassignment/{id}").hasAnyRole("STUDENT", "DOCENT", "COORDINATOR")
